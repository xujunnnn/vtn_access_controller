 ...
 */
package vtn_access_controller.cli.commands;
...
public class Vtn_access_controllerCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(Vtn_access_controllerCliTestCommand.class);
    protected final Vtn_access_controllerCliCommands service;

    public Vtn_access_controllerCliTestCommand(final Vtn_access_controllerCliCommands service) {
